...
events = coll.aggregate([{'$match': {'ActionGeo_CountryCode': { '$in': ['SP','CH','BR','IN','IT','UK','RS','TU','PL'] }}}, {'$sample': { 'size': 2000000 }}], allowDiskUse= True )
data = list(events)
events.close()
...
# countries = ['US','SP','CH','BR','IN','IT','UK','RS','TU','PL']
